...
extern const u8 gText_DefaultNameJeremy[];
extern const u8 gText_DefaultNameJacob[];
extern const u8 gText_DefaultNameJoseph[];
extern const u8 gText_DefaultNameJordan[];
extern const u8 gText_DefaultNameJosh[];
extern const u8 gText_DefaultNameJesse[];
extern const u8 gText_DefaultNameJack[];
extern const u8 gText_DefaultNameOlivia[];
extern const u8 gText_DefaultNameAnna[];
extern const u8 gText_DefaultNameMary[];
extern const u8 gText_DefaultNameInnia[];
