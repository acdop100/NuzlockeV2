...
#define OPTIONS_DELETE_MON_OFF 1
#define OPTIONS_DELETE_MON_ON 0

#define OPTIONS_DELETE_WO_OFF 1
#define OPTIONS_DELETE_WO_ON 0

#define OPTIONS_DELETE_WO_PLUS_OFF 1
#define OPTIONS_DELETE_WO_PLUS_ON 0

#define OPTIONS_SINGLE_CATCH_OFF 1
#define OPTIONS_SINGLE_CATCH_ON 0

#define OPTIONS_STARTER_CHOOSE_OFF 1
#define OPTIONS_STARTER_CHOOSE_ON 0
