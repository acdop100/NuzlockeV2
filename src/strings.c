...
const u8 gText_WOPlusDelete[] = _("WHITEOUT PLUS");
...
const u8 gText_NuzDeleteOnwhiteoutPlusOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_NuzDeleteOnwhiteoutPlusOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
