...
const u8 gText_DefaultNameJeremy[] = _("JEREMY");
const u8 gText_DefaultNameJacob[] = _("JACOB");
const u8 gText_DefaultNameJoseph[] = _("JOSEPH");
const u8 gText_DefaultNameJordan[] = _("JORDAN");
const u8 gText_DefaultNameJosh[] = _("JOSH");
const u8 gText_DefaultNameJesse[] = _("JESSE");
const u8 gText_DefaultNameJack[] = _("JACK");
const u8 gText_DefaultNameOlivia[] = _("OLIVIA");
const u8 gText_DefaultNameAnna[] = _("ANNA");
const u8 gText_DefaultNameMary[] = _("MARY");
const u8 gText_DefaultNameInnia[] = _("INNIA");
...
const u8 gText_NuzDeleteMonOnFaintOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_NuzDeleteMonOnFaintOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_NuzDeleteOnwhiteoutOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
